    ...
    <div class="col-md">
		<div class="col-md-2">
			<div class="list-group"  style="position:fixed;">
			  	...
			  	<a href="#ass" class="list-group-item">Assessment</a>
			  	<a href="#ann" class="list-group-item">Anncouncement</a>
			  	<a href="#others" class="list-group-item">Others</a>
			</div>
		</div>
		<div class="col-md-10">
			<div id="gen_info"><?php include('gen_info.php');?></div>
			<div id="syllabus"><?php include('syllabus.php');?></div>
			<div id="ass"><?php include('ass.php');?></div>
			<div id="#ann"><?php include('ancmnt.php');?></div>
		</div>
	</div>
